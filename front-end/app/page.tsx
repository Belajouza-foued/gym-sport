...
export default function HomePage() {
 const featured = [
  { name: "Gym Shirt", price: 99, image: "shirt1.jpg" },
  { name: "Hoodie", price: 129, image: "hoodie.jpg" },
  { name: "Shorts", price: 69, image: "shorts.jpg" },
  { name: "Shoes", price: 149, image: "shoes.jpg" },
];
      ...
      <section className="px-6 md:px-20 py-20 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6">
            Build Your <span className="text-green-500">Fitness</span> Style
          </h1>

          <p className="text-gray-400 text-lg mb-8 max-w-xl">
            Premium gym clothing, accessories and supplements
            designed for performance and confidence.
          </p>
        ...
        {/* HERO IMAGE */}
        <div className="bg-gray-900  relative rounded-3xl h-[500px] flex items-center justify-center ">
                 <Image
  src="/images/hero.jpg"
  alt="Hero"
  fill
...
/>
  <h2 className="text-lg font-bold text-white absolute">
    Gym Shirt
  </h2>
        </div>
 ...
 <div className="grid md:grid-cols-4 gap-6">
  ...
  {featured.map((product, index) => (
    <div
      key={index}
      className="bg-gray-900 p-4 rounded-2xl hover:scale-105 transition"
    >

      <div className="relative h-40 bg-gray-800 rounded mb-4 overflow-hidden">
